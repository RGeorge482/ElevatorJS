...
const buildingElevators = new Elevator();
setInterval(buildingElevators.travel, 1000);

// test runs
buildingElevators.goTo(2);
buildingElevators.goTo(8);
buildingElevators.goTo(1);
buildingElevators.goTo(6);
buildingElevators.goTo(7);
buildingElevators.goTo(4);
buildingElevators.goTo(10);
buildingElevators.goTo(1);
setTimeout(() => {
  buildingElevators.goTo(7)
}, 1000);
